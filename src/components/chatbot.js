...
export default function Chatbot() {
    ...
    const appendMessage = (message) => {
        ...
        const profile_pic = "https://media2.giphy.com/media/tHIRLHtNwxpjIFqPdV/giphy.gif?cid=6c09b952894udvuaog6xakqwgyrj18tkh3bcyjugg4cc711x&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=g"
